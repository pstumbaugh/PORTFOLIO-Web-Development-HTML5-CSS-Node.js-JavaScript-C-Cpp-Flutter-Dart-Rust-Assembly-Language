...
void Postludes::postludesMain()
{
    int choice = 1;
    
    while (choice)
    {
        cout << endl << "POSTLUDES MENU" << endl;
        cout << "Please selection an option below:" << endl;
        cout << "   1. Display all postludes by title and last changed date." << endl;
        cout << "   2. View all information for a specific song." << endl;
        cout << "   3. Edit a specific song." << endl;
        cout << "   4. Add a new song to Postludes." << endl;
        cout << "   5. Delete a song from Postludes." << endl;
    ...
    //Add a new song
        else if (choice == 4)
        {
            if (addNewSong() == false)
                ...
                cout << endl << "New postlude song added successfully." << endl << endl;
        }
    //Delete a song
        else if (choice == 5)
        {
