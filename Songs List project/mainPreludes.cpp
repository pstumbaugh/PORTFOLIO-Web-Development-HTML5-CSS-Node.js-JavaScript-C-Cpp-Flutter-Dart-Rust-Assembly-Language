...
void Preludes::preludesMain()
{
    int choice = 1;
    
    while (choice)
    {
        cout << endl << "PRELUDES MENU" << endl;
        cout << "Please selection an option below:" << endl;
        cout << "   1. Display all preludes by title and last changed date." << endl;
        cout << "   2. View all information for a specific song." << endl;
        cout << "   3. Edit a specific song." << endl;
        cout << "   4. Add a new song to Preludes." << endl;
        cout << "   5. Delete a song from Preludes." << endl;
    ...
    //Add a new song
        else if (choice == 4)
        {
            if (addNewSong() == false)
                ...
                cout << endl << "New prelude song added successfully." << endl << endl;
        }
    //Delete a song
        else if (choice == 5)
        {
